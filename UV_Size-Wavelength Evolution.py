...
for x in ini_fold :
    ...
    for y in regions :
        ...
        for z in galaxies:
            ...
            file_hlr_dust=save_path+edited+"/Half_light_R_scipy_uv.txt"
            file_sed_dust=final+"/flares_cube_UV_sed.dat"
...
plt.xlim(0.13,0.4)
#plt.ylim(0.75,1.25)
plt.ylabel("$\mathdefault{R_{\u03bb}}$/$\mathdefault{R_{0.15um}}$")
plt.xlabel("$\u03bb$(um)")
...
plt.grid(axis='both')
#plt.show()
plt.savefig("/home/projects/dtu_00026/people/paupun/sizewavevoluv.png")
